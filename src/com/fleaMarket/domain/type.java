...
public class type {
	...
	private String type_belong;  //类型属于
	...
	public void setType_belong(String type_belong) {
	...
	public String toString() {
		return "type [type_id=" + type_id + ", type_name=" + type_name + ", type_belong=" + type_belong
				+ ", type_creationtime=" + type_creationtime + ", type_modifytime=" + type_modifytime + ", is_delete="
				+ is_delete + "]";
	}
}
