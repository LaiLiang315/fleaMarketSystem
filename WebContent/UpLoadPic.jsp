...
<div id="main" class="clearfix" style="width: 1170px">
	...
	<div class="publish-main layui-form layui-form-pane">
		<div class="input-line image" id="test2">
			<div class="layui-box layui-upload-button" id="test1"
		...
		<div class="layui-form-item layui-form-text input-line">
			...
			<div class="layui-input-block">
				<textarea id="goods_describe" name="goods_describe"
					placeholder="请输入商品详情" class="layui-textarea goods-des"></textarea>
			</div>
		</div>
		<div class="layui-form-item input-line">
			<label class="layui-form-label">分类</label>
			<div class="layui-input-inline">
				<select name="goodsInfo.goods_type" id="selectTypes"
		...
		<div class="layui-form-item input-line" id="price">
			...
			<div class="layui-input-inline">
				<input type="text" name="goods_price" autocomplete="off"
					placeholder="请输入价格" class="layui-input price">
			</div>
		...
		<div class="layui-form-item input-line">
			...
			<div class="layui-input-block">
				...
				<div class="layui-unselect layui-form-radio">
					<i class="layui-anim layui-icon"></i><span>线下交易</span>
				</div>
				<input type="radio" class="buyMethod" name="transactionMode"
					value="2" title="在线交易/线下交易" checked="">
				<div class="layui-unselect layui-form-radio layui-form-radioed">
					<i class="layui-anim layui-icon"></i><span>在线交易/线下交易</span>
				</div>
			</div>
		</div>
		<div class="layui-form-item input-line" id="address">
			...
			<div class="layui-input-block">
				<input type="text" name="exchange_adress" autocomplete="off"
					placeholder="请输入交易地址" class="layui-input goods-address">
			</div>
		</div>
		<div class="layui-form-item input-line" id="phoneNumber">
			...
			<div class="layui-input-inline">
				<input type="text" name="user_phoneNum" autocomplete="off"
					placeholder="请输入手机号" class="layui-input phone-number"
					value="${user_session.username}">
			</div>
			<label class="layui-form-label">QQ号</label>
			<div class="layui-input-inline">
				<input type="text" name="user_qq" autocomplete="off"
					placeholder="请输入QQ号" class="layui-input qq-number">
			</div>
			<label class="layui-form-label">微信号</label>
			<div class="layui-input-inline">
				<input type="text" name="user_weixin" autocomplete="off"
					placeholder="请输入微信号" class="layui-input wx-number">
			</div>
		</div>
